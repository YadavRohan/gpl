...
variable_declaration:
    simple_type  T_ID  optional_initializer
    {
      ...
      if($1 == INT)
      {
         stb->insert(*$2, new Symbol(INT, *$2));
      }
      else if($1 == DOUBLE)
      {
         stb->insert(*$2, new Symbol(DOUBLE, *$2));
      }
      else if($1 == STRING)
      {
         stb->insert(*$2, new Symbol(STRING, *$2));
      }
    }
    ...
    | simple_type  T_ID  T_LBRACKET T_INT_CONSTANT T_RBRACKET
    {
      ...
      if($1 == INT)
      {
         stb->insert(*$2, new Symbol(INT_ARRAY, *$2, $4));
      }
      else if($1 == DOUBLE)
      {
         stb->insert(*$2, new Symbol(DOUBLE_ARRAY, *$2, $4));
      }
      else if($1 == STRING)
      {
         stb->insert(*$2, new Symbol(STRING_ARRAY, *$2, $4));
      }
    }
    ;
